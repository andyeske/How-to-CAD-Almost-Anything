...
**Session Activities:** Using the tools learned on Session 1, we’ll design three objects, namely:
*	A cake.
...
**Session Activities:** Using the tools learned on S4, we’ll design three objects, namely:
...
**Session Activities:** Using the tools learned on Session 5, we’ll design three objects, namely:
...
**Session Activities:** Using the tools learned on Session 7, we’ll design a set of objects, namely:
...
**Session Activities:** Using the tools learned on Session 8, we’ll design two objects, namely:
...
**Session Activities:** Using the tools learned on Session 9, we’ll design one object, namely:
...
**Figure:** _Morning Session Student Cohort_.
</p>
